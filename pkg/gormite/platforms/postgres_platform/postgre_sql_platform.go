...
import (
	...
	"github.com/KoNekoD/gormite/pkg/gormite/platforms"
	"github.com/KoNekoD/gormite/pkg/gormite/schema_managers"
	"github.com/KoNekoD/gormite/pkg/gormite/schema_managers/postgres_schema_manager"
...
func (p *PostgreSQLPlatform) GetBooleanTypeDeclarationSQL(column map[string]interface{}) string {
	return `BOOLEAN`
}
func (p *PostgreSQLPlatform) GetIntegerTypeDeclarationSQL(column map[string]interface{}) string {
	return `INT` + p.GetCommonIntegerTypeDeclarationSQL(column)
}
func (p *PostgreSQLPlatform) GetBigIntTypeDeclarationSQL(column map[string]interface{}) string {
	return `BIGINT` + p.GetCommonIntegerTypeDeclarationSQL(column)
}
func (p *PostgreSQLPlatform) GetSmallIntTypeDeclarationSQL(column map[string]interface{}) string {
	return `SMALLINT` + p.GetCommonIntegerTypeDeclarationSQL(column)
}
func (p *PostgreSQLPlatform) GetGuidTypeDeclarationSQL(column map[string]interface{}) string {
	return `UUID`
}
func (p *PostgreSQLPlatform) GetDateTimeTypeDeclarationSQL(column map[string]interface{}) string {
	return `TIMESTAMP(0) WITHOUT TIME ZONE`
}
func (p *PostgreSQLPlatform) GetDateTimeTzTypeDeclarationSQL(column map[string]interface{}) string {
	return `TIMESTAMP(0) WITH TIME ZONE`
}
func (p *PostgreSQLPlatform) GetDateTypeDeclarationSQL(column map[string]interface{}) string {
	return `DATE`
}
func (p *PostgreSQLPlatform) GetTimeTypeDeclarationSQL(column map[string]interface{}) string {
	return `TIME(0) WITHOUT TIME ZONE`
}
func (p *PostgreSQLPlatform) GetCommonIntegerTypeDeclarationSQL(column map[string]interface{}) string {
...
func (p *PostgreSQLPlatform) GetClobTypeDeclarationSQL(column map[string]interface{}) string {
	return `TEXT`
}
...
func (p *PostgreSQLPlatform) GetBlobTypeDeclarationSQL(column map[string]interface{}) string {
	return `BYTEA`
}

func (p *PostgreSQLPlatform) GetDefaultValueDeclarationSQL(column map[string]interface{}) string {
	if v, ok := column[`autoincrement`]; ok && v == true {
		return ``
	}
...
func (p *PostgreSQLPlatform) GetJsonTypeDeclarationSQL(column map[string]interface{}) string {
